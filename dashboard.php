...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
        <div class="main-wrapper" style="background: linear-gradient(to right, #f1f2b5, #135058);">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title" style="background: linear-gradient(to right, #f1f2b5, #135058);">Student Result Management System || LGM </h2>
