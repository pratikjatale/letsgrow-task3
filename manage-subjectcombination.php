...
<?php include('includes/leftbar.php');?>  
                    ...
                    <div class="main-page"  style="background: linear-gradient(to right, #bdc3c7, #2c3e50);">
                        <div class="container-fluid" >
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title" style="background: linear-gradient(to right, #bdc3c7, #2c3e50);">Manage Subjects Combination</h2>
