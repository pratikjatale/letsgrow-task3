...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
        <div class="main-wrapper"  style="background: linear-gradient(to right, #bdc3c7, #2c3e50);">
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title" style="background: linear-gradient(to right, #bdc3c7, #2c3e50);">Add Subject Combination</h2>
